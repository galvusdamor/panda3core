...
trait HasExampleDomain4 extends HasExampleDomain2 {
  ...
  val task3: ReducedTask = ReducedTask("task3", isPrimitive = true, variableSort1(2) :: Nil, Nil, Nil,
                                       precondition = And[Literal](Literal(predicate1, isPositive = true, variableSort1(2) :: Nil) :: Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  val task4: ReducedTask = ReducedTask("task4", isPrimitive = false, variableSort1(3) :: Nil, Nil, Nil,
                                       precondition = And[Literal](Literal(predicate1, isPositive = true, variableSort1(3) :: Nil) :: Nil), effect = And[Literal](Nil), ConstantActionCost(0))

  val task5: ReducedTask = ReducedTask("task3", isPrimitive = true, variableSort1(4) :: Nil, Nil, Nil,
                                       precondition = And[Literal](Literal(predicate2, isPositive = true, variableSort1(4) :: Nil) :: Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  val task6: ReducedTask = ReducedTask("task4", isPrimitive = false, variableSort1(5) :: Nil, Nil, Nil,
                                       precondition = And[Literal](Literal(predicate2, isPositive = true, variableSort1(5) :: Nil) :: Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  ...
  val abstractTask2: ReducedTask = ReducedTask("abstractTask_2", isPrimitive = false, variableSort1(7) :: Nil, Nil, Nil,
                                               precondition = And[Literal](Literal(predicate1, isPositive = true, variableSort1(7) :: Nil) ::
                                                                             Literal(predicate2, isPositive = true, variableSort1(7) :: Nil) :: Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  val abstractTask3: ReducedTask = ReducedTask("abstractTask_3", isPrimitive = false, Nil, Nil, Nil, precondition = And[Literal](Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  ...
  val initTaskOfPlanOfDecompositionMethod3: ReducedTask = ReducedTask("initM3", isPrimitive = true, variableSort1(8) :: Nil, Nil, Nil, precondition = And[Literal](Nil), effect =
    And[Literal](Literal(predicate1, isPositive = true, variableSort1(8) :: Nil) :: Literal(predicate2, isPositive = true, variableSort1(8) :: Nil) :: Nil), ConstantActionCost(0))
  val goalTaskOfPlanOfDecompositionMethod3: ReducedTask = ReducedTask("goalM3", isPrimitive = true, Nil, Nil, Nil, precondition = And[Literal](Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  ...
  val noop                      : ReducedTask               = ReducedTask("__noop", isPrimitive = true, Nil,Nil, Nil, And[Literal](Nil), And[Literal](Nil), ConstantActionCost(0))
  ...
  val init4: ReducedTask = ReducedTask("init", isPrimitive = true, variableSort1(3) :: Nil, Nil, Nil, precondition = And[Literal](Nil), effect =
    And[Literal](Literal(predicate1, isPositive = true, variableSort1(3) :: Nil) :: Literal(predicate2, isPositive = true, variableSort1(3) :: Nil) :: Nil), ConstantActionCost(0))
  val goal4: ReducedTask = ReducedTask("goal", isPrimitive = true, Nil, Nil, Nil, precondition = And[Literal](Nil), effect = And[Literal](Nil), ConstantActionCost(0))
  ...
  val domain4 = Domain(sort1 :: Nil, predicate1 :: predicate2 :: Nil, task1 :: task2 :: task3 :: task4 :: task5 :: task6 :: abstractTask2 :: abstractTask3 :: Nil, decompositionMethod3 ::
    decompositionMethodEpsilon :: Nil, Nil, Map())
}
