(define (problem p03-split-with-cable)
 ...
 (:objects
  simple-dvd-1 simple-tv-1 scart-to-cinch-cable-1 - equipment
  simple-dvd-1-scart-1 simple-tv-1-cinch-1 simple-tv-1-cinch-2 scart-to-cinch-cable-1-scart-1 scart-to-cinch-cable-1-cinch-2 scart-to-cinch-cable-1-cinch-3 - connector
 )
 (:htn
  :tasks (and
 ...
 (:init
  ...
  (compatible simple-dvd-1-scart-1 scart-to-cinch-cable-1-scart-1)
  ...
  (compatible scart-to-cinch-cable-1-scart-1 simple-dvd-1-scart-1)
