...
public class entertainmentProbGen {
    static String baseDir = "/home/dh/IdeaProjects/panda3core_with_planning_graph/src/test/java/UUBenchmarksets/fromHTN/entertainment/";
    ...
    private static heProblem getProblem2() {
        heProblem p = new heProblem("p02-split");
        heDevice dvd = new heDvdPlayer();
        p.addDevice(dvd);
