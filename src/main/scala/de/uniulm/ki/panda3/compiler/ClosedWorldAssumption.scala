...
import de.uniulm.ki.panda3.csp.Equal
import de.uniulm.ki.panda3.domain.updates.{AddVariableConstraints, AddVariables, ExchangePlanStep}
import de.uniulm.ki.panda3.domain.{Domain, Task}
import de.uniulm.ki.panda3.logic.{Constant, Literal, Sort, Variable}
