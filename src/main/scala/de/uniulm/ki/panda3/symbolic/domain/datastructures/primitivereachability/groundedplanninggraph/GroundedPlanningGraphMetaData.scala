...
case class GroundedPlanningGraphMetaData(addedPropositions: Set[GroundLiteral] = Set.empty[GroundLiteral],
                                         ...
                                         preconditionBuckets: Map[GroundLiteral, Set[GroundTask]] = Map.empty[GroundLiteral, Set[GroundTask]],
                                         addBuckets: Map[GroundLiteral, Set[GroundTask]] = Map.empty[GroundLiteral, Set[GroundTask]],
                                         deleteBuckets: Map[GroundLiteral, Set[GroundTask]] = Map.empty[GroundLiteral, Set[GroundTask]]) {
