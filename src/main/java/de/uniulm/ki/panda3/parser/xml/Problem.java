...
public class Problem {
    ...
    protected List<ProblemConstantDeclaration> constantDeclaration;
     ...
     */
    public List<ProblemConstantDeclaration> getConstantDeclaration() {
        if (constantDeclaration == null) {
            constantDeclaration = new ArrayList<ProblemConstantDeclaration>();
        }
