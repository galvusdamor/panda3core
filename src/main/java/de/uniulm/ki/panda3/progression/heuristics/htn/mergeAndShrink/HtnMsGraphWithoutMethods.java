...
public class HtnMsGraphWithoutMethods extends   HtnMsGraph {



    public HtnMsGraphWithoutMethods(Integer[] nodeIDS, Tuple3<Integer, Integer, Integer>[] edges, HashMap<Integer, NodeValue> IDMapping, int startNodeID){
...
abstract class TemporaryHtnMsGraph{

    public int startNodeID;
    public LinkedList<Tuple3<Integer, Integer, Integer>> edges;
    public HashMap<Integer, NodeValue> idMapping;

    abstract HtnMsGraph convertToHtnMsGraph();

}

class TemporaryHtnMsGraphWithoutMethods extends TemporaryHtnMsGraph{

    public TemporaryHtnMsGraphWithoutMethods(LinkedList<Tuple3<Integer, Integer, Integer>> edges, HashMap<Integer, NodeValue> idMapping, int startNodeID){
    ...
    public HtnMsGraph convertToHtnMsGraph(){
        ...
        HtnMsGraph htnMsGraph = new HtnMsGraphWithoutMethods(nodeIDs, edgeArray, idMapping, startNodeID);
